...
1. Clone the repository:
    ```sh
    git clone https://github.com/Sterben230703/RAG-Builder.git
    cd RAG-Builder
    ```
...
4. in pdf_to_text.py update pdf_path
...
- **Local LLM**: If you have the capability to run a local LLM, you can use it for generating responses.
